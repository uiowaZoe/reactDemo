					...
					if (currCustomloadMoreComponent) {
						...
						prevs.push(
							<li key={itemKey}
								...
								onClick={this.onLoadMoreClick.bind(this, tree, curr, keyPath)}
							>
								<span>Load more <span class="glyphicon glyphicon-search"></span></span>
				...
				if (shouldDisplay) {
					if (curr.customComponent) {
						...
						prevs.push(
							...
							>
								<label>{nodeName}<span className="glyphicon glyphicon-chevron-down"></span></label>
							</div>
						);
					}
				}
				...
				if (shouldDisplay) {
					if (curr.customComponent) {
						...
						openedNode.push(
							<div key={key}
								onClick={this.onNodeClick.bind(this, tree, curr, keyPath)}
								className="infinity-menu-node-container-isOpen"
							>
								<label>{nodeName}<span className="glyphicon glyphicon-chevron-up"></span></label>
							</div>
						);
					}
